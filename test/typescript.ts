...
abstract class C { get C() { return 'C'; } };
...
// Argument of type 'F' is not assignable to parameter of type 'E'.
// let idF = registerE.push(objF);
let idF = registerE.push();

console.log('Create register for class but actually function G');
class G { get G() { return 'G'; } };
let objG = new G();
// Argument of type '() => string' is not assignable to parameter of type 'abstract new (...args: any[]) => unknown'
// let registerG = Raoi.new(() => { return 'G'; });
let registerG = Raoi.new();
